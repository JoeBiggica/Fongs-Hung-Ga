	...
	render() {
		return (
			<Head>
				...
				<meta name='twitter:image' content=`${domain}/static/fongs-social-logo.png` />
				...
				<link rel='shortcut icon' type='image/x-icon' href=`${domain}/static/favicon/favicon.png` />
				<link rel='icon' type='image/png' href=`${domain}/static/favicon/favicon.png' sizes='16x16` />
				<link rel='icon' type='image/png' href=`${domain}/static/favicon/favicon-32x32.png' sizes='32x32` />
				<link rel='icon' type='image/png' href=`${domain}/static/favicon/favicon-48x48.png' sizes='48x48` />
				<link rel='icon' type='image/png' href=`${domain}/static/favicon/favicon-96x96.png' sizes='96x96` />
