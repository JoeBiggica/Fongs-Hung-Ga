...
module.exports = {"container":"Header-container-3ZpuA","inner":"Header-inner-2A1qX","banner":"Header-banner-3w3mF","nav":"Header-nav-3jI7E","menu-container":"Header-menu-container-2rqw1","button":"Header-button-3USmz","menu":"Header-menu-sKL0B","active":"Header-active-1uMAQ"};;
    if (true) {
      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            ...
            injectCss(link, link.href.split("?")[0] + "?unix=1577994419969");
          });
      }
    }
    ...
    if (true) {
      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            if (!link.href.match(prefix) || link.stale) return;
            injectCss(link, link.href.split("?")[0] + "?unix=1577994420004");
          });
      }
    }
    ...
    if (true) {
      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            if (!link.href.match(prefix) || link.stale) return;
            injectCss(link, link.href.split("?")[0] + "?unix=1577994420063");
          });
      }
    }
...
//# sourceMappingURL=styles.5d923bd6048b904e1a5f.hot-update.js.map