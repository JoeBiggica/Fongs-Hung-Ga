...
function (_PureComponent) {
  ...
  function HeroBanner() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "getBackground", function (background_image, gradient) {
      switch (gradient) {
        case 'top':
          return "linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0)), url(".concat(background_image, ")");

        case 'bottom':
          return "linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.7) 20%), url(".concat(background_image, ")");
...
//# sourceMappingURL=classes.js.1d0979ddeadb6555ebe8.hot-update.js.map